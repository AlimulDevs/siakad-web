    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="text-right">
                <a class="btn btn-primary" href="/jurusan/create-index">
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="example2">
                    ...
                    <tbody class="text-center">
                        ...
                        $no = 1;
                        @endphp
                        @foreach ($data_jurusan as $dtk )
                        <tr>
                            <td>{{$no++}}</td>
                            <td>{{$dtk->name}}</td>
                            <td>

                                <a href="/jurusan/edit-index/{{$dtk->id}}" class="btn btn-sm btn-warning"><i class="fas fa-edit text-white"></i></a>

                                <a href="/jurusan/delete/{{$dtk->id}}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
