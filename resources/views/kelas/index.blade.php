...
<div class="container mt-5">
    ...
    <div class="card">
        <div class="card-header">
            <h1 class="text-center">TABEL KELAS</h1>

            <div class="text-right">
                <a class="btn btn-primary" href="/kelas/create-index">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/kelas/siswa-index/{{$dtk->id}}" class="btn btn-sm btn-primary"><i class="fas fa-users text-white"></i></a>
                                <a href="/kelas/edit-index/{{$dtk->id}}" class="btn btn-sm btn-warning"><i class="fas fa-edit text-white"></i></a>
