    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="text-right">
                <a class="btn btn-primary" href="/kelas/siswa/create-index/{{$kelas_id}}">
                ...
                <table class="table table-striped" id="example2">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>{{$dtg->jurusan->name}}</td>
                            <td>{{$dtg->kelas->nama}}</td>


                            <td>

                                <a href="/siswa/edit-index/{{$dtg->id}}" class="btn btn-sm btn-primary"><i class="fas fa-file-alt text-white"></i></a>
                                <a href="/siswa/edit-index/{{$dtg->id}}" class="btn btn-sm btn-warning"><i class="fas fa-edit text-white"></i></a>

                                <a href="/siswa/delete/{{$dtg->user->id}}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
